...
#		openssl genrsa -3 -out $1.pem 2048
		openssl req -new -x509 -key $1.pem -out $1.x509.pem -days 10000 -subj "/C=CN/ST=Shang Hai/L=Pu Dong/O=Ovenstone/OU=Ovenstone/CN=Ovenstone/emailAddress=pagxir@gmail.com"
